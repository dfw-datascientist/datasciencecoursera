...
```{r}
tidyDataDF <- read.table("tidyData.txt", head = TRUE)
...
- 2. Only measurements containing mean and std were collected.
- 3. Activity identifiers replaced with descriptive names.
- 4. Incoherent variable names and special characters have been dealt with as below:
